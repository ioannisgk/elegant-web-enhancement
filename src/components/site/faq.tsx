...
export const faqs = [
  ...
  },
  {
    ...
    a: "One fixed week: OS and servers preparation (day 1), DNS, load balancing and the three kubeadm clusters (day 2), GitLab and Argo CD (day 3), Rook-Ceph and Istio Ambient (day 4), Harbor and Jenkins (day 5), the observability stack (day 6), live high-availability failover drills (day 7).",
  },
  {
